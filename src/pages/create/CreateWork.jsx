    ...
    <div className="bottom-contents">
      ...
      <div className="posts-comments">
        ...
        <div className="comments-container">
          <input type="text" name="comments" placeholder="Add comments here..." value={comment} onChange={(e) => setComment(e.target.value)}/>
          <span className="comment-btn" onClick={handleComment}>post</span>
          <span>
